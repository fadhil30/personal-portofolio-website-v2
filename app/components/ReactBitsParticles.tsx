...
export default function ReactBitsParticles({
  ...
  const paletteKey =
    particleColors && particleColors.length > 0 ? particleColors.join("|") : "";
  ...
  useEffect(() => {
    ...
    const palette = paletteKey ? paletteKey.split("|") : defaultColors;
  ...
  return <div ref={containerRef} className={cn("reactbits-particles", className)} />;
}
